...
- Click a word or drag-select a phrase, confirm **Ask about this** — the answer lands as a numbered item under **NOTES** at the end of Grounding (not a new consult turn)
