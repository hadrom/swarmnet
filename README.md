...
- Click a word or drag-select a phrase, confirm **Ask about this** — the answer lands as a numbered item under **NOTES** in Grounding. Described words stay underlined; click one to jump back to its NOTES entry
